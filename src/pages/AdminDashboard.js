...
function AdminDashboard() {
    ...
    const [courts, setCourts] = useState([
        { id: 1, name: 'Sân Pickleball 1', type: 'Pickleball', status: 'Sân Trống' },
    ]);
    const [showModal, setShowModal] = useState(false);
    const [editCourt, setEditCourt] = useState(null);
    const [formData, setFormData] = useState({ name: '', type: 'Pickleball', status: 'Sân Trống' });
                            ...
                            {courts.map(court => (
                                <div key={court.id} className="court-card">
                                    <div className="court-header">
                                        ...
                                        <span className={`status-indicator ${court.status === 'Sân Trống' ? 'status-available' : 'status-booked'}`}>
                                            {court.status}
                                        </span>
                                    </div>
                                    <div className="court-details">
                                        <p><strong>Loại sân:</strong> {court.type}</p>
                                        <p><strong>Trạng thái:</strong> {court.status}</p>
                                    </div>
                        ...
                        {showModal && (
                            <div className="modal-overlay">
                                <div className="modal-content">
                                    <h3 className="modal-title">{editCourt ? 'Sửa sân' : 'Thêm sân'}</h3>
            ...
            <div className="sidebar">
                ...
                <ul className="sidebar-menu">
                    ...
                    >
                        ...
                        <i className={`fas fa-plus sidebar-icon ${userMenuOpen ? 'rotate' : ''}`}></i>
                    </li>
                    {userMenuOpen && (
